...
app.post('join_game',function(req, res){
	var joinGame = Object.keys(req.body)[0].split('~/');
	res.cookie("user_name",joinGame[0]);
	res.cookie("user_game_id",joinGame[1]);
	lib.handle_join_game(req, res, listOfGame[joinGame[1]], joinGame[0]);
});
