...
exports.sendUpdatedData = function(request, response, game){
  if(game) {
    ...
    if(game.isGameStarted){
      console.log("game in sendUpdatedData",game);
      startUno(game); 
...
var setCookie = function(cookieHeader){
 ...
 var generateTable  = function(userInfo) {
  ...
  var linkToHome = "<button onclick = 'resetCookie()'>go to logIn page</button>"
...
//==========================join game ================================================//
exports.handle_join_game = function(request, response, game, join_user_name){
  console.log("join user name",join_user_name);
  addUser(join_user_name, game);
